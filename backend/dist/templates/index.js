...
exports.resetPasswordTemplate = exports.registrationStatusEmailTemplate = exports.underReviewTemplate = void 0;
const underReviewTemplate = (contactName, companyName, redirectUrl) => `
  <!DOCTYPE html>
  <html lang="en">
  <head>
    <meta charset="UTF-8" />
...
`;
exports.underReviewTemplate = underReviewTemplate;
const registrationStatusEmailTemplate = (status, name, redirectUrl) => {
    const getMessage = () => {
        if (status === "APPROVED")
            return `
...
exports.registrationStatusEmailTemplate = registrationStatusEmailTemplate;
const resetPasswordTemplate = ({ otp, typeLabel = "password reset", expiryMinutes = 10, appName = "Solomongetnet", }) => `
<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
